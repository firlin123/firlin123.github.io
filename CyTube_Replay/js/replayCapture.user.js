...
(function() {
    ...
    var captureHeader = mkElem('div', {
        className: 'capture-header',
        innerText: 'Replay Capture'
    });
    var captureBtnContainer = mkElem('div');
    var captureBtn = mkElem('button', {
    ...
    var captureFileList = mkElem('div', {
        className: 'capture-file-list',
        innerText: 'Capture files:'
    });
    var captureCollapseBtn = mkElem('button', {
    ...
    function hookFields(object, fields) {
        for (let field of fields) {
            if (typeof object['hooked_' + field.name] === 'undefined') {
                let getter, setter;
                object['actual_' + field.name] = object[field.name];
